...
import { ArrowLeft, CheckCircle2, Clock, AlertTriangle, Users, Lock, Unlock, IndianRupee, Save, Info } from "lucide-react";
          ...
          {bAccount.pGroups.map((group) => {
            ...
            return (
              <div key={group.id} className="bg-background rounded-xl overflow-hidden">
                ...
                {/* Group member details (always visible for master) */}
